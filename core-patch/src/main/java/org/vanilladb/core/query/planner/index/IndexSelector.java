...
public class IndexSelector {
	...
	public static IndexSelectPlan selectByBestMatchedIndex(String tblName,
			TablePlan tablePlan, Predicate pred, Transaction tx, DistanceFn embField, Collection<String> excludedFields) {
	...
	public static IndexSelectPlan selectByBestMatchedIndex(Set<IndexInfo> candidates,
		...
		if (bestIndex != null) {
			return new IndexSelectPlan(tablePlan, bestIndex, searchRanges, tx, embField);
		}
